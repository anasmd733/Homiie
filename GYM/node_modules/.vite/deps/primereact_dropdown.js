...
var Tooltip = React8.memo(React8.forwardRef(function(inProps, ref) {
  ...
  var createElement12 = function createElement13() {
    ...
    return React8.createElement("div", _extends5({
      ref: elementRef
    }, rootProps), React8.createElement("div", arrowProps), React8.createElement("div", _extends5({
      ref: textRef
...
var VirtualScroller = React17.memo(React17.forwardRef(function(inProps, ref) {
  ...
  var createLoader = function createLoader2() {
    ...
    if (!props.loaderDisabled && props.showLoader && loadingState) {
      ...
      return React17.createElement("div", loaderProps, content2);
    }
    return null;
  };
  ...
  if (props.disabled) {
    ...
    return React17.createElement(React17.Fragment, null, props.children, content);
  } else {
    ...
    return React17.createElement("div", rootProps, _content, spacer, loader);
  }
}));
...
var Ripple = React18.memo(React18.forwardRef(function(inProps, ref) {
  var _React$useState = React18.useState(false), _React$useState2 = _slicedToArray6(_React$useState, 2), isMounted = _React$useState2[0], setMounted = _React$useState2[1];
  var inkRef = React18.useRef(null);
  ...
  return React18.createElement("span", _extends9({
    role: "presentation",
    ref: inkRef
  }, rootProps, {
    onAnimationEnd
...
var DropdownPanel = React20.memo(React20.forwardRef(function(props, ref) {
  ...
  var createItem = function createItem2(option, index) {
    ...
    if (props.optionGroupLabel) {
      ...
      return React20.createElement(React20.Fragment, {
        key
      }, React20.createElement("li", itemGroupProps, React20.createElement("span", itemGroupLabelProps, groupContent)), groupChildrenContent);
    } else {
      var optionLabel = props.getOptionLabel(option);
  ...
  var createContent = function createContent2() {
    if (props.virtualScrollerOptions) {
      ...
      return React20.createElement(VirtualScroller, _extends11({
  ...
  var createElement12 = function createElement13() {
    ...
    return React20.createElement(CSSTransition2, _extends11({
      nodeRef: ref
    }, transitionProps), React20.createElement("div", _extends11({
      ref
...
var Dropdown = React20.memo(React20.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React20.useState(""), _React$useState2 = _slicedToArray7(_React$useState, 2), filterState = _React$useState2[0], setFilterState = _React$useState2[1];
  var _React$useState3 = React20.useState(false), _React$useState4 = _slicedToArray7(_React$useState3, 2), focusedState = _React$useState4[0], setFocusedState = _React$useState4[1];
  var _React$useState5 = React20.useState(-1), _React$useState6 = _slicedToArray7(_React$useState5, 2), focusedOptionIndex = _React$useState6[0], setFocusedOptionIndex = _React$useState6[1];
  var _React$useState7 = React20.useState(false), _React$useState8 = _slicedToArray7(_React$useState7, 2), overlayVisibleState = _React$useState8[0], setOverlayVisibleState = _React$useState8[1];
  ...
  var createLabel = function createLabel2() {
    ...
    if (props.editable) {
      ...
      return React20.createElement("input", inputProps);
    } else {
      ...
      return React20.createElement("span", _inputProps, content);
    }
  };
  ...
  return React20.createElement(React20.Fragment, null, React20.createElement("div", rootProps, keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, React20.createElement(DropdownPanel, _extends11({
    hostName: "Dropdown",
    ref: overlayRef,
    visibleOptions,
    virtualScrollerRef
    ...
    sx
  }))), hasTooltip && React20.createElement(Tooltip, _extends11({
    target: elementRef,
